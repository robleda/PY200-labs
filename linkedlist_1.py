...
class LinkedList:
	class Node:
		...
		Inner class of Linked list. Takes links to the previous and next nodes if they exist.
		Also contains given data in any format.
		Links can be overridden via setters.
		"""
...
if __name__ == '__main__':
	...
	ll.insert_node(0, 'my_1st_node')
	ll.insert_node(1, 'my_2nd_node')
	ll.insert_node(2, 'my_3rd_node')
	ll.insert_node(-2, 'go_-2_weee')
	ll.show()
	print('beeeeeeeep')
	ll.delete(2)
	ll.show()
	print('beeeeeeeep')
	ll.append('omg_append_me')
	ll.append(None)
	ll.show()
